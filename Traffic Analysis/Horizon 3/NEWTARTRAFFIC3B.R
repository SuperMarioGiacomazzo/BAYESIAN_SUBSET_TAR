...
for(day in 1:5){
  ...
  for(series in 1:7){
    ...
    DATA.TRAIN=tar.data.func(day=day,series=series,P=P,h=3,nquant=nquant)
    ...
    train.data=tar.data.func(day=day,series=series,P=7,h=3,nquant=50)
    ...
    # png(filename=paste("SELECT1Fit3D",day,"S",series,".png",sep=""),width=800,height=500)
    # plot(train.data$data$y[order.forward1],col="gray50")
    # points(train.predict[order.forward1],type="l")
    # dev.off()
    
    test.data=tar.data.func2(day=day,series=series,P=7,h=3,nquant=50)
    ...
    # png(filename=paste("SELECT1Predict3D",day,"S",series,".png",sep=""),width=800,height=500)
    ...
    # png(filename=paste("SELECT2Fit3D",day,"S",series,".png",sep=""),width=800,height=500)
    # plot(train.data$data$y[order.forward1],col="gray50")
    ...
    # png(filename=paste("SELECT2Predict3D",day,"S",series,".png",sep=""),width=800,height=500)
    # plot(test.data$data$y[order.forward2],col="gray50")
    ...
    save.image("NEWTARTRAFFIC3B.Rdata")
  }
}
