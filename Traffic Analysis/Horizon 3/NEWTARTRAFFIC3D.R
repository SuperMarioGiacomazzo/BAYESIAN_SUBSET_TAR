...
for(day in DAY.ID){
  for(series in LOOP.ID){
    ...
    THRESH=seq.thresh.func(day=day,series=series,P=7,h=3,nquant=50)
    REG.IN=rep(NA,51)
...
write.csv(FINAL.MOD.NREGIME,file="NEWFINAL.MOD.NREGIME3.csv")
...
png("NEWThreshold3.png",width=800,height=1000)
ggplot(DELTA) +
...
#Specific Models
EX2=TAR.RESULTS3[[5]][[6]]$mean.coef
EX2
105%%8
logit.func(0.07)
