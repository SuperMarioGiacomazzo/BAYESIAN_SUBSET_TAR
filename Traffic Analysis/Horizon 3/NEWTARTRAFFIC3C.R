...
save.image("NEWTARTRAFFIC3C.Rdata")
...
png(filename="NEWEST3Plots.png",width=1200,height=1200)
...
png(filename="NEWDENS3Plots.png",width=1200,height=1200)
par(mfrow=c(7,1),mar=c(1.9,3.9,2.3,.5))
for(series in LOOP.ID){
...
xtable(MASE.TAR3.3)
write.csv(round(MASE.TAR3.3,2),file="NEWMASETAR33.csv")
