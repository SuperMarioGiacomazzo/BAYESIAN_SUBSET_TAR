...
for(day in 1:5){
  ...
  TAR.RESULTS[[day]]=foreach(series=1:7)%do%{
    ...
    out=tar.data.func(day=day,series=series,P=7,h=1,nquant=50)
    ...
    png(filename=paste("Fit1D",day,"S",series,".png",sep=""),width=800,height=500)
    ...
    png(filename=paste("Predict1D",day,"S",series,".png",sep=""),width=800,height=500)
